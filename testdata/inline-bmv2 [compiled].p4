...
control IngressI() {
  ...
  table do_aux_adjust_lkp_fields_0/do_aux_adjust_lkp_fields() @name("do_aux.adjust_lkp_fields") {
    key = { tmp_ipv4.isValid(): exact; }
  ...
  tbl_act.apply();
  do_aux_adjust_lkp_fields_0/do_aux_adjust_lkp_fields.apply(); }
control EgressI() { }
control DeparserI() { }
