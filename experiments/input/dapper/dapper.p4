...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("parse_tcp") state parse_tcp {
        ...
        meta.my_metadata.parse_tcp_options_counter = hdr.tcp.dataOffset * 4w4 - 4w4;
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("use_sample_rtt_first") action use_sample_rtt_first() {
        ...
        meta.stats_metadata.dummy2 = meta.intrinsic_metadata.ingress_global_timestamp;
    ...
    @name("update_flow_sent") action update_flow_sent() {
        ...
        meta.stats_metadata.dummy = meta.intrinsic_metadata.ingress_global_timestamp;
    ...
    @name("use_sample_rtt") action use_sample_rtt() {
        ...
        meta.stats_metadata.dummy = meta.stats_metadata.dummy >> 32w3;
