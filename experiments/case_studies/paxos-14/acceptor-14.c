...
void drop_tbl_201391() {
	...
	switch(symbol) {
		case 0: _drop_0_201365(); break;
		case 1: _nop_0_201381(); break;
		default: NoAction_0_201355(); break;
	}
	// keys: meta.local_metadata.set_drop:exact
	// size 2
...
void handle_1a_0_201532() {
	action_run = 201532;
	uint32_t learner_port;
	klee_make_symbolic(&learner_port, sizeof(learner_port), "learner_port");
	hdr.paxos.msgtype = 1;
	...
	hdr.paxos.vrnd = tmp_symbolic;
		...
		uint64_t tmp_symbolic;
	klee_make_symbolic(&tmp_symbolic, sizeof(tmp_symbolic), "tmp_symbolic");
	hdr.paxos.paxosval = tmp_symbolic;
...
void acceptor_tbl_201777() {
	...
	klee_make_symbolic(&symbol, sizeof(symbol), "symbol");
	switch(symbol) {
		case 0: handle_1a_0_201532(); break;
		case 1: handle_2a_0_201619(); break;
		case 2: _drop_1_201706(); break;
		default: NoAction_1_201477(); break;
	}
...
void forward_tbl_201838() {
	...
	klee_make_symbolic(&symbol, sizeof(symbol), "symbol");
	switch(symbol) {
		case 0: forward_0_201729(); break;
		case 1: _drop_4_201722(); break;
		default: NoAction_6_201478(); break;
	}
...
void round_tbl_201896() {
	...
	klee_make_symbolic(&symbol, sizeof(symbol), "symbol");
	switch(symbol) {
		case 0: read_round_0_201746(); break;
		default: NoAction_7_201479(); break;
	}
	// size 1
