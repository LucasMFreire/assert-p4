...
void schedule_table_112625() {
	...
	klee_assume(!(hdr.ipv4.dstAddr == 4009886210 && hdr.rtp.timestamp >= 3 && hdr.rtp.timestamp <= 4));
	if(hdr.ipv4.dstAddr == 4009820417 && hdr.rtp.timestamp >= 5 && hdr.rtp.timestamp <= 15){
